...
data class UserStatsLast7Days(
    ...
    @SerializedName("daily_including_holidays") val dailyIncludingHolidays: Double,
    val range: String,
    ...
    val editors: List<EditorLast7Days>? = null,
    val languages: List<LanguageLast7Days>? = null,
    val machines: List<MachineLast7Days>? = null,
    val projects: List<ProjectLast7Days>? = null,
    @SerializedName("operating_systems") val operatingSystems: List<OperatingSystemLast7Days>? = null,
    val categories: List<CategoryLast7Days>? = null,
)