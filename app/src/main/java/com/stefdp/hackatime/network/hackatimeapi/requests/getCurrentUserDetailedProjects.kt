...
suspend fun getCurrentUserDetailedProjects(): Result<List<ProjectDetail>> {
    try {
        ...
        if (!response.isSuccessful) {
            ...
            Log.e("HackatimeApi[getCurrentUserDetailedProjects]", "Request failed with code: $statusCode and message: ${response.message()}")
        ...
        Log.e("HackatimeApi[getCurrentUserDetailedProjects]", "Exception occurred: ${e.message}", e)
