...
private const val TAG = "HackatimeApi[getMyMostRecentHeartbeats]"

suspend fun getMyMostRecentHeartbeats(
    context: Context,
    editor: String? = null
): Result<GetMyMostRecentHeartbeatsResponse> {
    try {
        ...
        val response = ApiClient.hackatimeApi.getMyMostRecentHeartbeats(
        ...
        if (body is GetMyMostRecentHeartbeatsResponse) {
