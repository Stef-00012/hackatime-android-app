...
suspend fun getUserTrustFactor(
    ...
    try {
        ...
        if (!response.isSuccessful) {
            ...
            Log.e("HackatimeApi[getUserTrustFactor]", "Request failed with code: $statusCode and message: ${response.message()}")
        ...
        Log.e("HackatimeApi[getUserTrustFactor]", "Exception occurred: ${e.message}", e)
