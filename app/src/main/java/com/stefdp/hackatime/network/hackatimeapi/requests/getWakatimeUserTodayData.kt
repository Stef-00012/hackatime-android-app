...
private const val TAG = "HackatimeApi[getWakatimeUserTodayData]"

suspend fun getWakatimeUserTodayData(
    context: Context,
    userId: String = "current",
): Result<GetWakatimeUserTodayDataResponse> {
    try {
        ...
        val response = ApiClient.hackatimeApi.getWakatimeUserTodayData(
        ...
        if (body is GetWakatimeUserTodayDataResponse) {
