{
    ...
    in {
        ...
        echo "no" | avdmanager create avd -k 'system-images;android-36;google_apis;x86_64' -n $avd
        cd demo-app-$date
        ...
        devShell.x86_64-linux = pkgs.mkShell ( rec { 
            ...
            GRADLE_OPTS = "-Dorg.gradle.project.android.aapt2FromMavenOverride=${ANDROID_SDK_ROOT}/build-tools/${latest-build-tools}/aapt2";
