		...
		<>
			<header className="border-b-darkless justify-between flex items-center p-4.5 border-b border-solid">
				<div className="flex items-center">
					<Image
						...
						height={50}
					/>
					<p className="font-bold text-[22px] ml-3 mr-0 my-0">
						Hackatime Android
					</p>
				</div>
				...
				<div>
					...
					>
						<svg
							...
							height="24"
							viewBox="0 0 24 24"
							className="text-white transition-[color] duration-[0.3s] ease-[ease] hover:text-muted"
						>
							<title>GitHub</title>
							<path
								fill="currentColor"
			...
			<main className="px-9 py-3 max-sm:p-3">
				<h3 className="font-bold text-xl">
					Hackatime is an Android app to view your{" "}
					<Link
				...
				<div className="flex flex-wrap my-2">
					<div title="Google Play is currently in closed testing">
						<Link href="https://play.google.com/store/apps/details?id=com.stefdp.hackatime">
							<Image src={googlePlayButton} alt="Download on Google Play" />
						</Link>
					</div>
				...
				>
					<div className="font-bold text-[1.13em] tracking-[0.01em] mb-2.5">
						Use the following Hackatime dummy account
					</div>

					<div className="mb-2.5">
						<span className="font-semibold text-smoke inline mb-0">
							API Key:
						</span>
						<span className="text-red ml-1 font-mono">
							6d985801-1b89-43e4-9475-48f351da6657
						</span>

						<span className="text-sm! text-muted block mt-2">
							The account linked to this API key is not linked to any slack user
							and will not be used for any YSWS, I just created a new mail and
							made an hackatime account with it
						</span>
					</div>
				</Tooltip>
				...
				<div>
					<p className="text-xl my-2">
						<b>View your all time data or a specific date range.</b> You can
						view your hackatime total time, top language and top project along
						with a pie chart with all data for any date range.
					</p>

					<p className="text-xl my-2">
						<b>View your last 7 days data.</b> You can view your hackatime last
						7 days time, top language, top project, top editor, top OS and top
						machine along with a pie chart with all data.
					</p>

					<p className="text-xl my-2">
						<b>View your projects.</b> You can view all your hackatime projects
						and also open their github repo if available.
					</p>

					<p className="text-xl my-2">
						<b>Lock the app behind auth.</b> You can optionally lock the app
						behind biometric authentication (fingerprint, face or pin code).
					</p>
				</div>
				...
				<div className="flex justify-center">
					<div className="w-75 bg-elevated p-2 pb-0 rounded-2xl">
						<Slider dots swipeToSlide>
							{previewImages.map((image, index) => (
								// biome-ignore lint/suspicious/noArrayIndexKey: The index is the only unique value here
								<div key={index}>
									<Image
										src={image}
			...
			<footer className="text-center p-5">
				<p className="text-xl">
					...
					<span>
						<Link href="/privacy" className="text-red!">
							Privacy Policy
						</Link>
					</span>{" "}
					| {version}
