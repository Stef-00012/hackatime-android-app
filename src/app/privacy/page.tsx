export default function Privacy() {
    return (
        <div className="p-3">
            ...
            <p className="text-xl">The app allows its users to view the data of their <a className="text-red!" href="https://hackatime.hackclub.com" target="_blank" rel="noopener">Hackatime</a> account. All interactions occur directly between the user's device and <a className="text-red!" href="https://hackatime.hackclub.com" target="_blank" rel="noopener">Hackatime</a>. The Hackatime Android app does not collect any data from user interactions.</p>

            <h2 className="text-2xl font-bold my-3">Login Data</h2>
            <p className="text-xl">Upon login, the Hackatime Android app stores the user's API key on the user's device in the app's private storage. This API key is used solely to keep the user logged in and avoid repeated authentication. This API key is only shared with <a className="text-red!" href="https://hackatime.hackclub.com" target="_blank" rel="noopener">Hackatime</a> to authenticate the HTTPs requests and with the app's server via HTTPs to allow background taks such as goals and motivational notifications.</p>
